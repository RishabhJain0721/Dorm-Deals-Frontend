...
const LandingPage = () => {
  return (
    <div className=" bg-[url('C:\Users\welcome\OneDrive\Desktop\drom\Dorm-Deals-Frontend\src\Images\landingimg.jpg')]  bg-[length:800px_700px] min-h-screen  flex flex-col justify-center items-center text-center px-4">
